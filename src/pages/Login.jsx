  ...
  const PageHome=()=>(
    <>
      ...
      <section style={{paddingTop:56,background:SURF,borderBottom:`1px solid ${BORDER}`}}>
        <div style={{maxWidth:1040,margin:'0 auto',padding:isMobile?'40px 20px':'56px 40px',display:isMobile?'block':'grid',gridTemplateColumns:'1fr 1fr',gap:60,alignItems:'center'}}>
          {/* Gauche */}
          <div>
      ...
      {/* FEATURES 3 colonnes */}
      <section style={{padding:isMobile?'40px 20px':'56px 40px',background:BG}}>
